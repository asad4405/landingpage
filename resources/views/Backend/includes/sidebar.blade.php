...
<nav class="settings-sidebar">
    <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
            ...
            <a class="theme-item active" href="{{ asset('public/Backend') }}/demo_1/dashboard-one.html">
                <img src="{{ asset('public/Backend') }}/assets/images/screenshots/light.jpg" alt="light theme">
            </a>
            <h6 class="mb-2 text-muted">Dark Theme:</h6>
            <a class="theme-item" href="{{ asset('public/Backend') }}/demo_2/dashboard-one.html">
                <img src="{{ asset('public/Backend') }}/assets/images/screenshots/dark.jpg" alt="light theme">
            </a>
        </div>
    </div>
</nav>
